                        ...
                        <div className="relative group p-px rounded-[2rem] bg-gradient-to-b from-white/10 to-transparent hover:from-[#00ff99]/20 transition-all duration-700">
                            ...
                            <div className="relative bg-[#0b0f12] rounded-[2rem] overflow-hidden p-8 md:p-12 border border-white/5 flex flex-col md:flex-row items-center gap-10 md:gap-16">
                                ...
                                <div className="w-full md:w-auto flex-shrink-0 flex justify-center order-1 md:order-1">
                                    <div className="relative w-44 md:w-52 group/photo">
                                        ...
                                        <div className="relative w-full rounded-[2rem] overflow-hidden border-2 border-white/10 shadow-2xl">
                                            <img
                                                src="/rafael.jpg"
                                                alt="Rafael Venturi"
                                                className="w-full h-auto block transition-transform duration-700 group-hover/photo:scale-105"
                                            />
                                        </div>
                                    </div>
                                </div>
